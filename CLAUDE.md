...
| Toasts | `sonner` |
| Package manager | npm |
| Hosting | Vercel — production at https://outlierlabs.tech (alias https://outlier-fawn.vercel.app), deployed by GitHub Actions on push to `main` ([.github/workflows/ci.yml](.github/workflows/ci.yml)) |
